...
if { $colstore } {
set sql(1) "create table dbo.customer (c_custkey bigint not null, c_mktsegment char(10) null, c_nationkey int null, c_name varchar(25) null, c_address varchar(40) null, c_phone char(15) null, c_acctbal money null, c_comment varchar(118) null, c_visible_time_start datetime2, c_visible_time_end datetime2, c_system_time_start datetime2 GENERATED ALWAYS AS ROW START, c_system_time_end datetime2 GENERATED ALWAYS AS ROW END, PERIOD FOR SYSTEM_TIME (c_system_time_start,c_system_time_end), index cust_cs clustered columnstore) WITH (SYSTEM_VERSIONING = ON)" 
set sql(2) "create table dbo.lineitem (l_shipdate date null, l_orderkey bigint not null, l_discount money not null, l_extendedprice money not null, l_suppkey int not null, l_quantity bigint not null, l_returnflag char(1) null, l_partkey bigint not null, l_linestatus char(1) null, l_tax money not null, l_commitdate date null, l_receiptdate date null, l_shipmode char(10) null, l_linenumber bigint not null, l_shipinstruct char(25) null, l_comment varchar(44) null, l_active_time_start datetime2, l_active_time_end datetime2, l_system_time_start datetime2 GENERATED ALWAYS AS ROW START, l_system_time_end datetime2 GENERATED ALWAYS AS ROW END, PERIOD FOR SYSTEM_TIME (l_system_time_start,l_system_time_end),index lineit_cs clustered columnstore) WITH (SYSTEM_VERSIONING = ON)" 
...
set sql(4) "create table dbo.part( p_partkey bigint not null, p_type varchar(25) null, p_size int null, p_brand char(10) null, p_name varchar(55) null, p_container char(10) null, p_mfgr char(25) null, p_retailprice money null, p_comment varchar(23) null, p_availability_time_start datetime2, p_availability_time_end datetime2, p_system_time_start datetime2 GENERATED ALWAYS AS ROW START, p_system_time_end datetime2 GENERATED ALWAYS AS ROW END, PERIOD FOR SYSTEM_TIME (p_system_time_start,p_system_time_end), index part_cs clustered columnstore) WITH (SYSTEM_VERSIONING = ON)" 
set sql(5) "create table dbo.partsupp( ps_partkey bigint not null, ps_suppkey int not null, ps_supplycost money not null, ps_availqty int null, ps_comment varchar(199) null, p_retailprice money null, p_comment varchar(23) null, ps_validity_time_start datetime2, ps_validity_time_end datetime2, ps_system_time_start datetime2 GENERATED ALWAYS AS ROW START, ps_system_time_end datetime2 GENERATED ALWAYS AS ROW END, PERIOD FOR SYSTEM_TIME (ps_system_time_start,ps_system_time_end), index psupp_cs clustered columnstore) WITH (SYSTEM_VERSIONING = ON)" 
...
set sql(7) "create table dbo.supplier( s_suppkey int not null, s_nationkey int null, s_comment varchar(102) null, s_name char(25) null, s_address varchar(40) null, s_phone char(15) null, s_acctbal money null, s_system_time_start datetime2 GENERATED ALWAYS AS ROW START, s_system_time_end datetime2 GENERATED ALWAYS AS ROW END, PERIOD FOR SYSTEM_TIME (s_system_time_start,s_system_time_end), index suppl_cs clustered columnstore) WITH (SYSTEM_VERSIONING = ON)" 
set sql(8) "create table dbo.orders( o_orderdate date null, o_orderkey bigint not null, o_custkey bigint not null, o_orderpriority char(15) null, o_shippriority int null, o_clerk char(15) null, o_orderstatus char(1) null, o_totalprice money null, o_comment varchar(79) null, o_active_time_start datetime2, o_active_time_end datetime2, o_receivable_time_start datetime2, o_receivable_time_end datetime2, o_system_time_start datetime2 GENERATED ALWAYS AS ROW START, o_system_time_end datetime2 GENERATED ALWAYS AS ROW END, PERIOD FOR SYSTEM_TIME (o_system_time_start,o_system_time_end), index ord_cs clustered columnstore) WITH (SYSTEM_VERSIONING = ON)"
	} else {
set sql(1) "create table dbo.customer (c_custkey bigint not null PRIMARY KEY CLUSTERED, c_mktsegment char(10) null, c_nationkey int null, c_name varchar(25) null, c_address varchar(40) null, c_phone char(15) null, c_acctbal money null, c_comment varchar(118) null, c_visible_time_start datetime2, c_visible_time_end datetime2, c_system_time_start datetime2 GENERATED ALWAYS AS ROW START, c_system_time_end datetime2 GENERATED ALWAYS AS ROW END, PERIOD FOR SYSTEM_TIME (c_system_time_start,c_system_time_end)) WITH (SYSTEM_VERSIONING = ON)" 
set sql(2) "create table dbo.lineitem (l_shipdate date null, l_orderkey bigint not null, l_discount money not null, l_extendedprice money not null, l_suppkey int not null, l_quantity bigint not null, l_returnflag char(1) null, l_partkey bigint not null, l_linestatus char(1) null, l_tax money not null, l_commitdate date null, l_receiptdate date null, l_shipmode char(10) null, l_linenumber bigint not null, l_shipinstruct char(25) null, l_comment varchar(44) null,l_active_time_start datetime2, l_active_time_end datetime2, l_system_time_start datetime2 GENERATED ALWAYS AS ROW START, l_system_time_end datetime2 GENERATED ALWAYS AS ROW END, PERIOD FOR SYSTEM_TIME (l_system_time_start,l_system_time_end),PRIMARY KEY CLUSTERED(L_ORDERKEY, L_LINENUMBER)) WITH (SYSTEM_VERSIONING = ON)" 
...
set sql(4) "create table dbo.part( p_partkey bigint not null PRIMARY KEY CLUSTERED, p_type varchar(25) null, p_size int null, p_brand char(10) null, p_name varchar(55) null, p_container char(10) null, p_mfgr char(25) null, p_retailprice money null, p_comment varchar(23) null,p_availability_time_start datetime2, p_availability_time_end datetime2, p_system_time_start datetime2 GENERATED ALWAYS AS ROW START, p_system_time_end datetime2 GENERATED ALWAYS AS ROW END, PERIOD FOR SYSTEM_TIME (p_system_time_start,p_system_time_end)) WITH (SYSTEM_VERSIONING = ON)" 
set sql(5) "create table dbo.partsupp( ps_partkey bigint not null, ps_suppkey int not null, ps_supplycost money not null, ps_availqty int null, ps_comment varchar(199) null,ps_validity_time_start datetime2, ps_validity_time_end datetime2, ps_system_time_start datetime2 GENERATED ALWAYS AS ROW START, ps_system_time_end datetime2 GENERATED ALWAYS AS ROW END, PERIOD FOR SYSTEM_TIME (ps_system_time_start,ps_system_time_end),PRIMARY KEY CLUSTERED(PS_PARTKEY,PS_SUPPKEY)) WITH (SYSTEM_VERSIONING = ON)" 
set sql(6) "create table dbo.region(r_regionkey int not null, r_name char(25) null, r_comment varchar(152) null)"
set sql(7) "create table dbo.supplier( s_suppkey int not null PRIMARY KEY CLUSTERED, s_nationkey int null, s_comment varchar(102) null, s_name char(25) null, s_address varchar(40) null, s_phone char(15) null, s_acctbal money null,s_system_time_start datetime2 GENERATED ALWAYS AS ROW START, s_system_time_end datetime2 GENERATED ALWAYS AS ROW END, PERIOD FOR SYSTEM_TIME (s_system_time_start,s_system_time_end)) WITH (SYSTEM_VERSIONING = ON)" 
set sql(8) "create table dbo.orders( o_orderdate date null, o_orderkey bigint not null PRIMARY KEY CLUSTERED, o_custkey bigint not null, o_orderpriority char(15) null, o_shippriority int null, o_clerk char(15) null, o_orderstatus char(1) null, o_totalprice money null, o_comment varchar(79) null,o_active_time_start datetime2, o_active_time_end datetime2, o_receivable_time_start datetime2, o_receivable_time_end datetime2, o_system_time_start datetime2 GENERATED ALWAYS AS ROW START, o_system_time_end datetime2 GENERATED ALWAYS AS ROW END, PERIOD FOR SYSTEM_TIME (o_system_time_start,o_system_time_end)) WITH (SYSTEM_VERSIONING = ON)"
}
