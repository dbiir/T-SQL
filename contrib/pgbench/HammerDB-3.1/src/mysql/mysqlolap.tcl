...
O_ACTIVE_TIME_START TIMESTAMP(6),
O_ACTIVE_TIME_END TIMESTAMP(6),
O_RECEIVABLE_TIME_START TIMESTAMP(6),
O_RECEIVABLE_TIME_END TIMESTAMP(6),
PRIMARY KEY (`O_ORDERKEY`),
FOREIGN KEY (`O_CUSTKEY`) REFERENCES CUSTOMER(`C_CUSTKEY`),
INDEX ORDERS_DT_IDX (`O_ORDERDATE`)
)
ENGINE = $mysql_tpch_storage_engine WITH TEMPORAL"
...
PS_VALIDITY_TIME_START TIMESTAMP(6),
PS_VALIDITY_TIME_END TIMESTAMP(6),
...
C_VISIBLE_TIME_START TIMESTAMP(6),
C_VISIBLE_TIME_END TIMESTAMP(6),
...
P_AVAILABILITY_TIME_START TIMESTAMP(6),
P_AVAILABILITY_TIME_END TIMESTAMP(6),
...
L_ACTIVE_TIME_START TIMESTAMP(6),
L_ACTIVE_TIME_END TIMESTAMP(6),
