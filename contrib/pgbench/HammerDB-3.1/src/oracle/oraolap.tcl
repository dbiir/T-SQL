...
set curn1 [ oraopen $lda ]
if { $timesten } {
set sql(1) "CREATE TABLE ORDERS (O_ORDERDATE DATE, O_ORDERKEY TT_BIGINT NOT NULL, O_CUSTKEY TT_BIGINT NOT NULL, O_ORDERPRIORITY CHAR(15), O_SHIPPRIORITY TT_INTEGER, O_CLERK CHAR(15), O_ORDERSTATUS CHAR(1), O_TOTALPRICE BINARY_DOUBLE, O_COMMENT VARCHAR(79),O_ACTIVE_TIME_START DATE,O_ACTIVE_TIME_END DATE,O_RECEIVABLE_TIME_START DATE,O_RECEIVABLE_TIME_END DATE)"
set sql(2) "CREATE TABLE PARTSUPP (PS_PARTKEY TT_BIGINT NOT NULL, PS_SUPPKEY TT_BIGINT NOT NULL, PS_SUPPLYCOST BINARY_DOUBLE NOT NULL, PS_AVAILQTY TT_INTEGER, PS_COMMENT VARCHAR(199),PS_VALIDITY_TIME_START DATE,PS_VALIDITY_TIME_END DATE)"
set sql(3) "CREATE TABLE CUSTOMER(C_CUSTKEY TT_BIGINT NOT NULL, C_MKTSEGMENT CHAR(10), C_NATIONKEY TT_INTEGER, C_NAME VARCHAR(25), C_ADDRESS VARCHAR(40), C_PHONE CHAR(15), C_ACCTBAL BINARY_FLOAT, C_COMMENT VARCHAR(118),C_VISIBLE_TIME_START DATE,C_VISIBLE_TIME_END DATE)"
set sql(4) "CREATE TABLE PART(P_PARTKEY TT_BIGINT NOT NULL, P_TYPE VARCHAR(25), P_SIZE TT_INTEGER, P_BRAND CHAR(10), P_NAME VARCHAR(55), P_CONTAINER CHAR(10), P_MFGR CHAR(25), P_RETAILPRICE BINARY_FLOAT, P_COMMENT VARCHAR(23),P_AVAILABILITY_TIME_START DATE,P_AVAILABILITY_TIME_END DATE)"
...
set sql(8) "CREATE TABLE LINEITEM(L_SHIPDATE DATE, L_ORDERKEY TT_BIGINT NOT NULL, L_DISCOUNT BINARY_FLOAT NOT NULL, L_EXTENDEDPRICE BINARY_FLOAT NOT NULL, L_SUPPKEY TT_BIGINT NOT NULL, L_QUANTITY TT_INTEGER NOT NULL, L_RETURNFLAG CHAR(1), L_PARTKEY TT_BIGINT NOT NULL, L_LINESTATUS CHAR(1), L_TAX BINARY_FLOAT NOT NULL, L_COMMITDATE DATE, L_RECEIPTDATE DATE, L_SHIPMODE CHAR(10), L_LINENUMBER TT_BIGINT NOT NULL, L_SHIPINSTRUCT CHAR(25), L_COMMENT VARCHAR(44),L_ACTIVE_TIME_START DATE,L_ACTIVE_TIME_END DATE)"
        } else {
set sql(1) "CREATE TABLE ORDERS (O_ORDERDATE DATE, O_ORDERKEY NUMBER NOT NULL, O_CUSTKEY NUMBER NOT NULL, O_ORDERPRIORITY CHAR(15), O_SHIPPRIORITY NUMBER, O_CLERK CHAR(15), O_ORDERSTATUS CHAR(1), O_TOTALPRICE NUMBER, O_COMMENT VARCHAR(79),O_ACTIVE_TIME_START DATE,O_ACTIVE_TIME_END DATE,O_RECEIVABLE_TIME_START DATE,O_RECEIVABLE_TIME_END DATE) PCTFREE 2 PCTUSED 98  INITRANS 8  PARALLEL"
set sql(2) "CREATE TABLE PARTSUPP (PS_PARTKEY NUMBER NOT NULL, PS_SUPPKEY NUMBER NOT NULL, PS_SUPPLYCOST NUMBER NOT NULL, PS_AVAILQTY NUMBER, PS_COMMENT VARCHAR(199),PS_VALIDITY_TIME_START DATE,PS_VALIDITY_TIME_END DATE) PARALLEL"
set sql(3) "CREATE TABLE CUSTOMER(C_CUSTKEY NUMBER NOT NULL, C_MKTSEGMENT CHAR(10), C_NATIONKEY NUMBER, C_NAME VARCHAR(25), C_ADDRESS VARCHAR(40), C_PHONE CHAR(15), C_ACCTBAL NUMBER, C_COMMENT VARCHAR(118),C_VISIBLE_TIME_START DATE,C_VISIBLE_TIME_END DATE) PCTFREE 0 PCTUSED 99 PARALLEL"
set sql(4) "CREATE TABLE PART(P_PARTKEY NUMBER NOT NULL, P_TYPE VARCHAR(25), P_SIZE NUMBER, P_BRAND CHAR(10), P_NAME VARCHAR(55), P_CONTAINER CHAR(10), P_MFGR CHAR(25), P_RETAILPRICE NUMBER, P_COMMENT VARCHAR(23),P_AVAILABILITY_TIME_START DATE,P_AVAILABILITY_TIME_END DATE) PARALLEL"
