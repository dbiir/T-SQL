...
static struct config_bool ConfigureNamesBool[] =
{
...

	{
		 ...
		 *
		 * [williamcliu] We set the default for autovacuum to 'on' because we use autovacuum
		 * to do historical versions transfering.
		 */
		true,
		NULL, NULL, NULL
	},
