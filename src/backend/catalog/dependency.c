...
#include "catalog/tdsql_route_master_node.h"
#include "catalog/tdsql_route_segment_node.h"
...
static const Oid object_classes[MAX_OCLASS] = {
	...
	TdsqlRouteMasterNodeRelationId,	/* OCLASS_TDSQL_ROUTE_MASTER_NODE */
	TdsqlRouteSegmentNodeRelationId,/* OCLASS_TDSQL_ROUTE_SEGMENT_NODE */
	RocksDBRelationId,			/* OCLASS_PG_ROCKSDB */
...
getObjectClass(const ObjectAddress *object)
{
	...
	switch (object->classId)
	{
		...
		case TdsqlRouteMasterNodeRelationId:
			return OCLASS_TDSQL_ROUTE_MASTER_NODE;

		case TdsqlRouteSegmentNodeRelationId:
			return OCLASS_TDSQL_ROUTE_SEGMENT_NODE;
			
		case RocksDBRelationId:
			return OCLASS_PG_ROCKSDB;
