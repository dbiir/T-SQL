							  ...
							  int serializedDtxContextInfoLen)
{
	...
	*qeError = NULL;
    ...
    dtxProtocolParms.serializedDtxTS = palloc0(DtxTimeStamp_SerializeSize());
    DtxTimeStamp_Serialize(dtxProtocolParms.serializedDtxTS, &global_tmp_timestamp);
    dtxProtocolParms.serializedDtxTSlen = DtxTimeStamp_SerializeSize();
	/*
						 ...
						 int *finalLen)
{
    ...
    char       *serializedDtxTS = pDtxProtocolParms->serializedDtxTS;
    int         serializedDtxTSlen = pDtxProtocolParms->serializedDtxTSlen;
