...
%type <temporal> temporal_clause opt_temporal_clause
...
%token <keyword> ABORT_P ABSOLUTE_P ACCESS ACTION ADD_P ADMIN AFTER
	...
	TABLE TABLES TABLESPACE TEMP TEMPLATE TEMPORAL TEMPORARY TEXT_P THEN TIME TIMESTAMP
 ...
 */
table_ref:	relation_expr opt_alias_clause opt_temporal_clause
				{
					$1->alias = $2;
					$1->temporal = $3;
					$$ = (Node *) $1;
...
temporal_clause:
			...
			| TEMPORAL FROM Sconst TO Sconst
				{
					$$ = makeNode(Temporal);
					$$ -> lower = $3;
					$$ -> upper = $5;
...
opt_temporal_clause: temporal_clause				{ $$ = $1; }
			| /*EMPTY*/								{ $$ = NULL; }
		;
