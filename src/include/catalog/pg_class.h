 ...
 * RELSTORAGE_ROCKSDB - stored on disk using rocksdb.
...
#define 	  RELSTORAGE_ROCKSDB 'r'  /* add rocksdb storage type */
...
static inline bool relstorage_is_rocksdb(char c)
{
	return (c == RELSTORAGE_ROCKSDB);
}
