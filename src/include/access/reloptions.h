...
/* These are the valid values of storage_engine option.
 * In greenplum, the default storage type/engine is heap. 
 * We add storage_engine option, which can be set as "rocksdb" or other storage types defined in pg_class.h
 */
#define DEFAULT_STORAGE_ENGINE           HEAP_STORAGE_ENGINE
#define HEAP_STORAGE_ENGINE              "heap"
#define AOROWS_STORAGE_ENGINE            "aorows"
#define AOCOLS_STORAGE_ENGINE            "aocols"
#define ROCKSDB_STORAGE_ENGINE           "rocksdb"
#define PARQUET_STORAGE_ENGINE           "parquet"
#define VIRTUAL_STORAGE_ENGINE           "virtual"
#define FOREIGN_STORAGE_ENGINE           "foreign"
#define EXTERNAL_STORAGE_ENGINE          "external"
