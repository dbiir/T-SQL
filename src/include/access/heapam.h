...
extern void UpdateXmaxHintBits(HeapTupleHeader tuple, Buffer buffer, TransactionId xid, Relation rel);
...
extern HTSU_Result test_lockmode_for_conflict(MultiXactStatus status, TransactionId xid,
...
extern void heap_page_prune_execute(Relation relation, Buffer buffer,
