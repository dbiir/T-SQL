...
extern bool  gp_catalog_update_standby_info(void);

extern Datum catalog_update_standby_info(PG_FUNCTION_ARGS);
extern Datum catalog_del_info_by_port(PG_FUNCTION_ARGS);
