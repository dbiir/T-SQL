...
extern int SerializeTuple(TupleTableSlot *tuple, TupleKeySlice key, Oid rangeid, SerTupInfo *pSerInfo, struct directTransportBuffer *b, TupleChunkList tcList, int16 targetRoute);
 ...
 * HeapTuple.
 */
extern GenericTuple CvtChunksToTup(TupleChunkList tclist, SerTupInfo * pSerInfo, TupleRemapper *remapper, TupleKeySlice *key, Oid *rangeid);
